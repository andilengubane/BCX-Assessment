...
$.validator.addMethod("rsaid", function (value, element, param) {
    window.alert("Inside the method!!");
    var idnumber = value;
    ...
    var tempDate = new Date(idnumber.substring(0, 2), parseInt(idnumber.substring(2, 4)) - 1, idnumber.substring(4, 6));
    if (!((tempDate.getYear() == idnumber.substring(0, 2)) &&
        (tempDate.getMonth() == parseInt(idnumber.substring(2, 4)) - 1) &&
